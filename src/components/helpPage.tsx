        ...
        <Box>
            ...
            <Typography component={"span"} variant="body1">
                <CardWithShadow sx={{ margin: 2 }}>
                    <p>
                        Use the Attacker and Defender selection buttons to add
                        soldiers to the battlefield. The attackers target
                        defenders top to bottom, while skipping defenders that
                        are already killed by other attackers.
                    </p>
                    <span>
                        ...
                        <ul>
                            ...
                            <li>
                                First number: Hitpoints of soldier before the
                                battle. You can adjust this number with direct
                                input by clicking on the number field
                            </li>
                            <li>
                                Second number: Hitpoints of the soldier after
                                the battle{" "}
                            </li>
                            ...
                            <li>
                                SPLSH: When toggled, unit is doing splash damage
                            ...
                            <li>
                                BST: When toggled, unit is boosted by Cymanti
                                shaman
                            </li>
                            <li>
                                MX##: Set the maximum health for ships to 10,
                                15, 20, 25, or 30 hitpoints. Maximum hitpoints
                                affects attacking and defensive power
                            </li>
                            <li>
                            ...
                            <li>
                                POIS: When green, unit is poisoned after attack
                                by Raychi, Exida, Phychi, or exploding unit.
                            </li>
                        </ul>
                    </span>
                    <p>
                        ...
                        <br />
                        A big thanks to Programming with Mosh, Midjiwan and the
                        Polytopia community!
                        <br />
                        Press F12 to find the worst source code you have ever
                        seen. Also available on{" "}
                        ...
                        however, if you like, you can support the website via{" "}
